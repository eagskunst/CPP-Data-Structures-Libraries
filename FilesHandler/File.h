...
class File {
    public:
         ...
         */
        File(char *name, T(*toObject)(char *str), char*(*toString)(T Obj) ) { init(name, toObject, toString); }
        ~File(){}
        ...
        void write(char *source){ file.write(source, 300); }
        ...
        void gotoSOF(bool read = true){ // Go to the start of the file.
            ...
            //Clear the error flags triggered by the previous file stream.
            file.clear();
        }
        ...
        char* asString(T buffer){ return toString(buffer); }
        char* asString(){ return asString(buffer); }
    ...
    private:
         ...
         * and return the char sequence representation of the argument. 
         */
        void init(char* name, T(*toObject)(char *str), char*(*toString)(T obj) );
};


template <typename T>
void File<T>::init(char* name, T(*toObject)(char *str), char*(*toString)(T obj) ){
